        ...
        <section className={"py-16"}>
            <div className="mx-auto max-w-8xl px-4 md:px-8 lg:px-20">
                <div className="grid items-start gap-10 lg:grid-cols-2">
                    {/* Left */}
                    <div>
                        <div className="text-[14px] font-semibold tracking-[0.18em] text-primary-700 uppercase">About pizza fornata</div>

                        <h2 className="mt-3 text-[36px] font-extrabold leading-tight">Get to know us!</h2>
                        ...
                        {bullets.length ? (
                            <ul className="mt-5 ms-5 space-y-7">
                                {bullets.map(b => (
